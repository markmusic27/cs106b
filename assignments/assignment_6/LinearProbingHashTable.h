// This file defines the interface for the LinearProbingHashTable including all of the private and public data types that will be used
...
private:
    ...
    // Variable tracks the number of slots in the array
    int kNumSlots;
    int numElems;

    // Hash function will be initalized in constructor
